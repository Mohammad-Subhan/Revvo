            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12">
                    ...
                    <div className="space-y-6">
                        ...
                        <div>
                            ...
                            <ul className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                                {["360 Camera", "Bluetooth", "GPS", "Heated Seats", "Rear View Mirror"].map((feature) => (
                ...
                <form onSubmit={handleSubmit} className="shadow-lg h-max sticky top-18 rounded-xl p-6 space-y-6 text-gray-500">
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        <input type="date" value={pickupDate} onChange={(e) => setPickupDate(e.target.value)} min={new Date().toISOString().split('T')[0]} className="border border-border-color px-3 py-2 rounded-lg" required id="pickup-date" />
                    </div>

                    <div className="flex flex-col gap-2">
                        <label htmlFor="return-date">Return Date</label>
                        <input type="date" min={pickupDate} value={returnDate} onChange={(e) => setReturnDate(e.target.value)} className="border border-border-color px-3 py-2 rounded-lg" required id="return-date" />
                    </div>
