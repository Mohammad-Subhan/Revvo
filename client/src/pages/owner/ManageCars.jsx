                        ...
                        {cars.map((car, index) => (
                            <tr key={index} className="border-t border-border-color">
                                <td className="p-3 flex items-center gap-3">
                                    <img src={car.image} className="h-12 w-12 rounded-md object-cover aspect-square" alt="" />
                                ...
                                <td className="flex items-center p-3">
                                    ...
                                    <img src={car.isAvailable ? assets.eye_close_icon : assets.eye_icon} className="cursor-pointer" alt="" onClick={() => toggleAvailability(car._id)} />

                                    <img src={assets.delete_icon} className="cursor-pointer" alt="" onClick={() => deleteCar(car._id)} />
