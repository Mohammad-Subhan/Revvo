            ...
            <motion.form
                ...
                <div className="flex flex-col md:flex-row items-start md:items-center gap-10 min-md:ml-8">
                    ...
                    <div className="flex flex-col items-start gap-2">
                        ...
                        <input value={returnDate} onChange={(e) => setReturnDate(e.target.value)} type="date" id="return-date" min={pickupDate} className="text-sm text-gray-500" required />
                    </div>
                ...
                <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="flex items-center justify-center gap-1 bg-primary text-white px-9 py-3 max-sm:mt-4 hover:bg-primary-dull rounded-full cursor-pointer">
